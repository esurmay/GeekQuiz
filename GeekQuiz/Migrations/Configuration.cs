namespace GeekQuiz.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GeekQuiz.Models.TriviaDbContext>
    {
        ...
        protected override void Seed(GeekQuiz.Models.TriviaDbContext context)
        {
            ...
            context.TriviaQuestions.AddOrUpdate(new TriviaQuestion
            {
